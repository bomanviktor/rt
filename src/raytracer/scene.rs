...
impl Scene {
    pub fn init(brightness: f64) -> Self {
        ...
        let cylinder = Cylinder::new(Point::new(0.0, 0.0, 0.0), 1.0, 2.0, Reflective);
        let sphere1 = Sphere::new(
            Vector3::new(3.0, 1.0, 0.0),
            1.0,
            Diffusive(Color::mint_green()),
        );
        let sphere2 = Sphere::new(Point::new(-3.0, 1.2, 0.0), 0.2, Diffusive(RGB::pink()));
        let sphere3 = Sphere::new(Point::new(-3.0, 0.2, 1.2), 0.2, Diffusive(RGB::coral()));
        let sphere4 = Sphere::new(Point::new(0.0, 2.5, 0.0), 0.5, Diffusive(RGB::gold()));
        let sphere5 = Sphere::new(Point::new(-1.5, 0.5, -1.0), 0.5, Diffusive(RGB::teal()));
        let cube = Cube::new(Point::new(-3.0, 0.5, 0.0), 1.0, Reflective);
        let _cubex = Cube::new(Point::new(4.0, 0.5, 1.5), 1.5, Diffusive(RGB::red()));
        ...
        let cube4 = Cube::new(
            ...
            1.0,
            Diffusive(RGB::new(255., 0.0, 255.)),
        );

        // AROUND SPHERE LIGHT
        let sphere_light = Sphere::new(Point::new(4.0, 3.8, 5.0), 0.8, Light(RGB::mint_green()));
        let beige_sphere = Sphere::new(Point::new(5.0, 0.5, 7.0), 0.5, Diffusive(RGB::beige()));
        ...
        let cube_sphere2 = Sphere::new(Point::new(-3.0, 0.3, -5.0), 0.3, Diffusive(RGB::orange()));
        let cube_sphere3 = Sphere::new(Point::new(-5.5, 0.4, -6.0), 0.4, Diffusive(RGB::silver()));

        // AROUND FLAT LIGHT
        let flat_light = FlatPlane::new(Point::new(6.0, 0.0001, -6.0), 1.0, Light(RGB::magenta()));
        let flat_sphere = Sphere::new(Point::new(6.0, 1.0, -6.0), 0.5, Reflective);
